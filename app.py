...
"""
Parse freebie offer text to extract quantity and product info
Examples: "22+2", "Buy 12 Get 2 Free", "11+1", etc.
"""
...
# Pattern 4: Check for "buy x get y" pattern
...
if selected_row is None:
    ...
    if refund_amount > 0:
        ...
        """.format(calculation_details), unsafe_allow_html=True)
